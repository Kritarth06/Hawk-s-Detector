...
export class FoundPatternsList extends LitElement {
    ...
    render() {
        ...
        return html`
        <div>
            <h2 style="color:white;">${brw.i18n.getMessage("headingFoundPatterns")}: ${this.results.countVisible}</h2>
            <ul>
...
export class authors extends LitElement {
    ...
    render() {
        return html`
        <div style="margin:0px; border: 1px solid white; color:white;">
            <h2 style="color:white; margin:5px;">Developed by The Hack Hawks</h2>
...
export class pw extends LitElement {
    ...
    render() {
        ...
        <div style="margin:0px; border: 1px solid white;">
            <h3 style="color:white;font-size:15px; ">${brw.i18n.getMessage("patternHiddenCost_w")}</h3>
        </div>
      ...
      if(www=="Scarcity"){
        return html`
        <div style="margin:0px; border: 1px solid white;">
            <h3 style="color:white;font-size:15px; ">${brw.i18n.getMessage("patternScarcity_w")}</h3>
        </div>
      ...
      if(www=="Social Proof"){
        return html`
        <div style="margin:0px; border: 1px solid white;">
            <h3 style="color:white;font-size:15px; ">${brw.i18n.getMessage("patternSocialProof_w")}</h3>
        </div>
      ...
      if(www=="Misdirection"){
        return html`
        <div style="margin:0px; border: 1px solid white;">
            <h3 style="color:white;font-size:15px; ">${brw.i18n.getMessage("patternMisdirection_w")}</h3>
        </div>
      ...
      if(www=="ConfirmShaming"){
        return html`
        <div style="margin:0px; border: 1px solid white;">
            <h3 style="color:white;font-size:15px; ">${brw.i18n.getMessage("patternConfirmShaming_w")}</h3>
        </div>
...
export class im extends LitElement {
    render() {
        return html`
        <div><img style="display: block; margin-left: auto; margin-right: auto;" src="../images/icon-128.png"></div>
      `;
    }
}
customElements.define("imm-m", im);